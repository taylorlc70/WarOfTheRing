...
public enum HighlightState{
	...
	MoveDest,
	CancelArmyMove,
	Recruit//More states to come later
}
...
public class GameManager: MonoBehaviour {
	...
	public static event PhaseSwitchEvent Rolling;
	public static event PhaseSwitchEvent Action;
	public static event PhaseSwitchEvent VictoryCheck;
...
//-----------------------------------------------------------------------
	...
	public void SetupBoard(){
		...
		List<string> spaces = GetRegionNamesList();
		for(int i = 0; i < spaces.Count; i++){ 
			GameObject newSpace = (Instantiate(Resources.Load("Prefabs/Space"), new Vector3(i+10,0,i), Quaternion.identity) as GameObject);
			newSpace.name = spaces[i];
		}
	}
//----------------------------------------------------------------------
